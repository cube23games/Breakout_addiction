...
class _RecoveryPlanScreenState extends State<RecoveryPlanScreen>{
  ...
  @override Widget build(BuildContext context){if(_loading)return const Scaffold(appBar:AppBar(title:Text('Recovery Plan')),body:Center(child:CircularProgressIndicator()));return Scaffold(appBar:AppBar(title:const Text('Recovery Plan')),body:ListView(padding:const EdgeInsets.all(AppSpacing.lg),children:[
